            ...
            <div class="col-lg-8 col-md-10 py-5 col_border m-auto">
                <div class="col-md-10 m-auto">
                    ...
                    <form action="php/controller.php" method="post">
                        ...
                        <button class="btn_button btn-block" name="login_user">Login</button>
                        <p class="py-4 text-center">Or</p>
                        <button onclick="window.location.href='register.php'" type="button" class="btn_button btn-block bg-dark text-light">register now</button>
                    </form>
                </div>
            </div>
        </div>
