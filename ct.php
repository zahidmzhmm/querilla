    ...
    if (isset($_SESSION['Product'])) {
        ...
        <table class="table table-bordered text-center">
            ...
            foreach ($_SESSION['Product'] as $cart => $values) {
                ...
                <tr>
                    ...
                    <td><a href=""><?= $array['title'] ?></a> <a class="cart_remove" data-pid="<?= $array['id'] ?>"
                                                                 href="javascript:void;"><br><i
                                    class="fas fa-times"></i></a></td>
                    <td>
                            <span class="">
                                <button data-pdctid="<?= $array['id']; ?>" data-pqnty="<?= $values['quantity'] ?>"
                                        class="btn min_quantity btn-sm">-</button>
                                <span><?= $qntity ?></span>
                                <button data-pdctid="<?= $array['id']; ?>" data-pqnty="<?= $values['quantity'] ?>"
                                        class="btn pls_qntity btn-sm">+</button>
                            </span>
                    </td>
                    <td>&dollar;<?= $price ?></td>
                </tr>
        ...
        <div class="row mx-0">
            <div class="cal-lg-4 pl-0 pl-lg-3 col-md-5 pr-0 ml-auto">
                ...
                <script src="https://www.paypal.com/sdk/js?client-id=AURryq0gyMoasRadzGZGm1u6eIadYNQJxXD7z5uE2BIoHEASjRxQLhBMu8XZUQaFP1g74Qo0tWXtO5vG&currency=USD"
