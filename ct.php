    ...
    ?>
        ...
        <div class="row mx-0">
            <div class="cal-lg-4 pl-0 pl-lg-3 col-md-5 pr-0 ml-auto">
                ...
                </table><div id="smart-button-container">
                        ...
                        paypal.Buttons({
                            ...
                            createOrder: function(data, actions) {
                                return actions.order.create({
                                    purchase_units: [{"amount":{"currency_code":"USD","value":<?= $totalamnt ?>}}]
                                });
                            },
                            ...
                            onApprove: function(data, actions) {
                                return actions.order.capture().then(function(details) {
                                    ...
                                    $.post("php/pay_submit.php", { email_address: email_address, name: name, payer_id: payer_id, product_id: product_value, amount: <?= $totalamnt ?>, cart_payment: "questions_ajax" })
                                        .done(function( data ) {
