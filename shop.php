    ...
    <section class="all_product mb-5">
        <div class="container-fluid">
            <?php if (isset($_SESSION['return'])) { ?>
                <div class="alert alert-warning"><?= $_SESSION['return'] ?></div> <?php unset($_SESSION['return']);
            } ?>
            <div class="row">
                <?php
                    ...
                    <div class="col-lg-3 col-xl-2 col-md-4 col-sm-6">
                        <div class="all_div mb-1">
                            <img style="height: 10rem;"
                                 src="<?= file_exists('uploads/' . $data['images']) ? 'uploads/' . $data['images'] : 'uploads/no-img.jpeg' ?>"
                                 alt=""/>
                            <div class="text">
                                <h5>
                                    <a href="product_details.php?product_id=<?= $data['id'] ?>"><?= $data['title'] ?></a>
                                </h5>
                                <div class="top_hover">
                                    <p>
                                        <span>$<?= $data['price'] ?></span> <span class="d-sm-none ml-3"><a
                                                    class="text-dark"
                                                    href="?addtocart=<?= $data['id'] ?>">+ Add to Cart</a></span>
                                    </p>
